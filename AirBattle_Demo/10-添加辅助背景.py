...
class Background(Model):
    ...
    # TODO 1.覆盖父类display方法，制作原始背景贴图+辅助背景贴图
    def display(self):
        Model.window.blit(self.img, (self.x, self.y))   # TODO 2.原始背景贴图，推荐使用super().display()
        Model.window.blit(self.img, (self.x, self.y - Game.WINDOW_HEIGHT)) # TODO 3.辅助背景，坐标位置与原始背景贴图上下拼接吻合
